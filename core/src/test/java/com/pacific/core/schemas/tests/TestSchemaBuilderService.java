...
public class TestSchemaBuilderService {
    ...
    public void testSchemaIsBuilt() {
        assertNotEquals("SchemaBuilder built 0 schemas",0, schemaBuilderService.getSchemas().size());
    }

    @Test
    public void testIfExpectedSchemaIsAvaialble() {
        Schema contactSchema = schemaBuilderService.getSchemas().get("com.pacific.core:Contact");
        assertNotNull("Contact schema not found", contactSchema);
        Schema emailSchema = schemaBuilderService.getSchemas().get("com.pacific.core:Email");
    ...
    public void testBasicSchemaMetadata() {
        ...
        Schema contactSchema = schemaBuilderService.getSchemas().get(id);
        ...
        assertEquals("Contact schema description is not correct", "Represents the Contact related info of a Person", contactSchema.getDescription());
    }
    ...
    public void testAttributeMetadata() {
        ...
        assertEquals("testField Description metadata not correct in contact schema", "Just a test field", testFieldAttr.getDescription());
    }
